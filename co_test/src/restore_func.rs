...
pub fn restore_all_params(s: &CanSocket) {
...
pub fn restore_communication_params(s: &CanSocket) {
    // [1017:00] = 0x64 (0), [6000:00] = 0x2 (8).
    send(&s, 0x602, 0x2B_17_10_00_64_00_00_00, 8);
    exp(&s, 0x582, 0x60_17_10_00_00_00_00_00, 8);
    send(&s, 0x602, 0x40_17_10_00_00_00_00_00, 8);
...
pub fn restore_application_params(s: &CanSocket) {
    // [1017:00] = 0x64 (0), [6000:00] = 0x2 (8).
    send(&s, 0x602, 0x2B_17_10_00_64_00_00_00, 8);
    exp(&s, 0x582, 0x60_17_10_00_00_00_00_00, 8);
    send(&s, 0x602, 0x40_17_10_00_00_00_00_00, 8);
...
pub fn error_restore_params(s: &CanSocket, sub_index: u8) {
